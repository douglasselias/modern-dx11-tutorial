...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
  ...
  D3DCompileFromFile(L"011_normal_light.hlsl", null, null, "vs_main", "vs_5_0", 0, 0, &vertex_shader_blob, null);
  ...
  D3DCompileFromFile(L"011_normal_light.hlsl", null, null, "ps_main", "ps_5_0", 0, 0, &pixel_shader_blob, null);
